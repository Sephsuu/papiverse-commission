...
export function RawMaterialLogsPage() {
    ...
    const { data, loading } = useFetchData<InventoryLog>(
        ...
        [claims.branch.branchId, tab, selectedMonthValue, selectedYear, "RAW_MATERIAL"],
    );
    ...
    }, [eventFilteredItems, selectedMonthValue, selectedYear]);
    ...
    const { page, setPage, size, paginated } = usePagination(filteredItems, 100);
    ...
    useEffect(() => {
        ...
        router.replace(`/logs/raw-materials?${params.toString()}`);
    }, [tab, eventTab, router]);
    ...
    return (
        <section className="stack-md animate-fade-in-up overflow-hidden max-md:mt-12">
            <AppHeader label="Raw Material Inventory Logs" />
