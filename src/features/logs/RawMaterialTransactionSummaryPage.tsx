...
import { InventoryItemAuditModal } from "../_inventory-v2/components/InventoryItemAuditModal";
...
export function RawMaterialTransactionSummaryPage() {
    ...
    return (
        <section className="stack-md animate-fade-in-up overflow-hidden max-md:mt-12">
            <AppHeader label="Raw Material Inventory Transactions" />
                                ...
                                <div className="td font-bold">
                                    {item.currentInventory !== item.previousInventory && Number(item.previousInventory) !== 0 && (
                                        ...
                                        >
                                            ...
                                            {formatDecimalWithoutRounding(((item.currentInventory - item.previousInventory) / item.previousInventory) * 100, 3)}
                                            %
                                        </span>
                                    )}
