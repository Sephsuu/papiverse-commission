        ...
        <section className="relative h-full bg-slate-50">
            <div className="reveal-down">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320">
                    ...
                    <path fill="#7b3306" fill-opacity="1" d="M0,96L80,122.7C160,149,320,203,480,229.3C640,256,800,256,960,240C1120,224,1280,192,1360,176L1440,160L1440,320L1360,320C1280,320,1120,320,960,320C800,320,640,320,480,320C320,320,160,320,80,320L0,320Z"></path>
                </svg>
