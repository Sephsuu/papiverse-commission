...
export function DatePicker({
    ...
    const displayDate = (iso: string) => {
        if (!iso) return placeholder ?? "Filter by day";
    ...
    const disableFutureDates = (d: Date) =>
        isAfter(d, today) || (disabledDates ? disabledDates(d) : false);
    ...
    return (
        ...
        <PopoverTrigger asChild>
            <Button
                variant="outline"
                className={cn(
                    "w-full h-full justify-between rounded-md text-left font-normal",
